      ...
      {show && (
        ...
        >
          <div className="dash-card p-5 md:p-6 flex items-start gap-4">
            <div className="w-9 h-9 rounded-xl bg-[#1E9BE0]/10 flex items-center justify-center shrink-0">
              <Cookie className="w-4 h-4 text-[#1E9BE0]" />
            </div>
            <div className="flex-1">
              ...
              <p className="mt-1.5 text-[13px] text-[#4B5563] leading-relaxed">
                ...
                <a href="/privacy" className="text-[#1E9BE0] hover:underline">Privacy</a>.
              </p>
