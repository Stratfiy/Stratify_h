    ...
    <div className="min-h-screen bg-white relative overflow-hidden flex flex-col">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 md:px-14 h-16 border-b border-[#F3F4F6] bg-white/80 backdrop-blur-sm">
        ...
        <p className="text-[13px] text-[#6B7280]">
          ...
          <Link to="/signup" className="text-[#1E9BE0] font-medium hover:underline">Sign up</Link>
        </p>
      </nav>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-[420px]">
          ...
          <h1 className="text-[36px] sm:text-[44px] leading-[1.05] tracking-[-0.025em] font-medium text-[#0A0A0A] mb-3">
            Sign in to your<br />
            <span className="text-[#1E9BE0]">dashboard.</span>
          </h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-[13px] text-[#1E9BE0] hover:underline font-medium">Forgot password?</Link>
              </div>
