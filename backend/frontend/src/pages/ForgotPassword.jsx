          ...
          {!sent ? (
            <>
              <div className="w-12 h-12 rounded-2xl bg-[#1E9BE0]/10 border border-[#1E9BE0]/20 flex items-center justify-center mb-6">
                <Mail className="w-5 h-5 text-[#1E9BE0]" />
              </div>
              ...
              <h1 className="text-[36px] sm:text-[44px] leading-[1.05] tracking-[-0.025em] font-medium text-[#0A0A0A] mb-3">
                Reset your<br />
                <span className="text-[#1E9BE0]">password.</span>
              </h1>
            ...
            <>
              ...
              <h1 className="text-[36px] sm:text-[44px] leading-[1.05] tracking-[-0.025em] font-medium text-[#0A0A0A] mb-3">
                Check your<br />
                <span className="text-[#1E9BE0]">inbox.</span>
              </h1>
              ...
              <p className="text-[14px] text-[#9CA3AF] mb-8">
                Didn't get it?{' '}
                <button onClick={() => setSent(false)} className="text-[#1E9BE0] font-medium hover:underline">Try again</button>
              </p>
