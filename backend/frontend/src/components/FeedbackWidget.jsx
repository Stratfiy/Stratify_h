          ...
          >
            ...
            {done ? (
              <div className="mt-4 text-center py-3">
                <div className="mx-auto w-10 h-10 rounded-full bg-[#4FB8EE]/15 flex items-center justify-center">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <button
                    ...
                    className={`flex-1 py-2 rounded-xl border transition-colors flex items-center justify-center gap-1.5 text-[13px] ${
                      rating === "up"
                        ? "bg-[#4FB8EE]/10 border-[#4FB8EE]/40 text-[#00A37D]"
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 rounded-xl border transition-colors flex items-center justify-center gap-1.5 text-[13px] ${
                      rating === "down"
                        ? "bg-[#1E9BE0]/10 border-[#1E9BE0]/30 text-[#1E9BE0]"
                        : "border-[#E5E7EB] text-[#0A0A0A] hover:bg-[#F3F4F6]"
                    }`}
                ...
                {rating && (
                  <>
                    <textarea
                      ...
                      className="mt-3 w-full rounded-xl border border-[#E5E7EB] px-3 py-2 text-[13px] focus:outline-none focus:ring-2 focus:ring-[#1E9BE0] resize-none"
