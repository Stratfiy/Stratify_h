...
export default function WorkflowDashboard() {
  ...
  return (
    <div className="relative" data-testid="workflow-dashboard">
      <div className="absolute -inset-6 bg-gradient-to-br from-[#0066FF]/10 via-transparent to-[#00D4AA]/10 blur-2xl rounded-3xl pointer-events-none" />
              ...
              >
                {VARIANT_LABELS.map((v, idx) => (
                  <motion.div
                    ...
                    className="aspect-[4/5] rounded-lg bg-gradient-to-br from-[#0066FF]/8 to-[#00D4AA]/15 border border-[#E5E7EB] p-2.5 flex flex-col justify-between"
                  >
          ...
          <AnimatePresence>
            {step === 3 && (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                transition={{ duration: 0.3 }}
                className="mt-4 rounded-xl bg-[#00D4AA]/10 border border-[#00D4AA]/25 px-3.5 py-3 flex items-center gap-3"
              >
                <Check className="w-4 h-4 text-[#00A37D] flex-shrink-0" />
                <div className="flex-1">
                  <div className="text-[12.5px] font-medium text-[#04342C]">Deployed to production</div>
                  <div className="font-mono text-[10px] tracking-wider uppercase text-[#04342C]/65 mt-0.5">monitoring active</div>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            <AnimatePresence initial={false}>
              {logs.map((l) => (
                ...
                >
                  ...
                  <span className="text-[#0066FF]">{l.service}</span>
