    ...
    >
      <div className="container-x flex items-center justify-between h-[68px]">
        ...
        <div className="flex items-center gap-2">
          {user ? (
            <>
              <span className="relative inline-flex items-center justify-center gap-2 rounded-full bg-[#1E9BE0] text-white font-medium text-[15px] px-6 py-3 cursor-not-allowed select-none opacity-85">
                Dashboard <ArrowRight className="w-4 h-4" />
                <span className="absolute -top-2 -right-3 bg-[#4FB8EE] text-[#04243C] font-mono text-[9px] font-medium tracking-wider uppercase px-2 py-0.5 rounded-full">
                  Soon
                </span>
              </span>
              <button
