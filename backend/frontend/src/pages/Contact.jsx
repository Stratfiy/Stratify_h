...
const inputCls =
  ...
  "placeholder-[#9CA3AF] focus:outline-none focus:ring-2 focus:ring-[#1E9BE0] focus:border-transparent transition";
        ...
        <div className="mt-10 space-y-3 text-[14px]">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#FBFBFD] border border-[#E5E7EB] flex items-center justify-center">
              <Mail className="w-4 h-4 text-[#1E9BE0]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#FBFBFD] border border-[#E5E7EB] flex items-center justify-center">
              <Phone className="w-4 h-4 text-[#1E9BE0]" />
            </div>
            <div>
...
function PausedCard() {
  return (
    <div className="text-center py-12" data-testid="contact-disabled">
      <div className="mx-auto w-14 h-14 rounded-full bg-[#1E9BE0]/10 flex items-center justify-center">
        <ShieldAlert className="w-6 h-6 text-[#1E9BE0]" />
      </div>
      ...
      <p className="mt-3 text-[15px] text-[#4B5563] max-w-[440px] mx-auto">
        ...
        <a href={`mailto:${CONTACT.email}`} className="text-[#1E9BE0]">{CONTACT.email}</a>{" "}
...
function SuccessCard() {
  return (
    <div className="text-center py-12" data-testid="contact-success">
      <div className="mx-auto w-14 h-14 rounded-full bg-[#4FB8EE]/15 flex items-center justify-center">
